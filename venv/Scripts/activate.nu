...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\PRAVALLIKA\Desktop\chatbot-deployment\chatbot-deployment\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\PRAVALLIKA\Desktop\chatbot-deployment\chatbot-deployment\venv\Scripts\deactivate.nu'
